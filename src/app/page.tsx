    ...
    <AppLayout>
      <div className="p-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Welcome to your Gantt Chart project management dashboard</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Visualize project timelines</CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/gantt">
                <Button variant="primary" size="sm">Open Gantt Chart</Button>
              </Link>
            </CardContent>
          </Card>
        </div>
